...
public class CategorizedWordTest {
    ...
    public void testAddCategory() {
        ...
        Assert.assertEquals(2, word.categoriesCount());
        word.addCategory(WordCategory.ADJECTIVE);
    ...
    public void testRemoveCategory() {
        final Word word = new CategorizedWord("Eubicor", WordCategory.VERB, WordCategory.NOUN, WordCategory.ADJECTIVE);

        Assert.assertEquals(3, word.categoriesCount());
        word.removeCategory(WordCategory.NOUN);
        Assert.assertEquals(2, word.categoriesCount());
        Assert.assertTrue(word.getCategories().containsAll(Arrays.asList(WordCategory.VERB, WordCategory.ADJECTIVE)));
        word.removeCategory(WordCategory.NOUN);
        Assert.assertEquals(2, word.categoriesCount());
        Assert.assertTrue(word.getCategories().containsAll(Arrays.asList(WordCategory.VERB, WordCategory.ADJECTIVE)));
        word.removeCategory(WordCategory.ADJECTIVE);
